function ToyData_New_Version_cell_single_Task_svg(nb_Tasks, nb_TrnExaPerTask, random, repeat_Number)
Number_Of_Tasks = nb_Tasks;
numberExamplesPerTaskForTraining = nb_TrnExaPerTask;
NumberOfPointsPerTask = 10000 + numberExamplesPerTaskForTraining; 
Run = random; 
