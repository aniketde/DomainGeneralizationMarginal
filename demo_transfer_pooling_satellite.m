...
load satellite_multi_class_500 % synth_parkinson_regression_data

task_type = 'multiclass'; % It could be either 'binary','multiclass' or 'regression'
numberOfTrainingUser = 400; %5,10,15,20,25,30,35, should be multuple of 5 and first (1:numberOfTrainingUser) will be selected as training datasets
useAllExamples = 1;
numberOfExamplesPerTask = 80;
...
D = 100;
numb_iter = 1;
rand_perm_test = 401:500; %  test datasets 
...
% end
save('satellite_multi_class_500_results_no_iter','res_avg_test','res_avg_train','res_avg_test_pooled','res_avg_train_pooled')
